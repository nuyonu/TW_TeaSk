    ...
    <div class="main-admin">
        ...
        <div class="body-admin">
            <div class="utils">
                ...
                <div class="buttons">
                    <button class="button-common" id="add-button" type="button">Adaugă un training</button>
                    <button class="button-common show-older-events" type="submit">Training-uri vechi</button>
                    <button class="button-common remove-events" type="submit"
                            onclick="document.getElementById('delete-events').submit()">Elimină training-uri
                    </button>
                </div>
            </div>
            <div class="data">
                <form action="adminTrainings/deleteTrainings" id="delete-events">
                    <table class="data-show">
                        <tr>
                            <th>Id.</th>
                            <th>Titlul trainingului</th>
                            <th>Organizator</th>
                            <th>Adaugat de</th>
                            <th>Mai multe</th>
                            <th>Șterge</th>
