document.write(
    '<link rel="stylesheet" type="text/css" href="../../public/assets/styles/navbar-new.css"/>\
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css"\
          integrity="sha384-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">\
    <nav class="navbar">\
        <img src="../../public/assets/images/logo.png" alt="Skill Enhancer"/>\
        <ul>\
            <li><a href="./index.php"><i class="fas fa-home"></i>Acasă</a></li>\
            <li><a href="./events.php"><i class="fas fa-calendar-week"></i>Evenimente</a></li>\
            <li><a href="./trainings.php"><i class="fas fa-user-graduate"></i>Training-uri</a></li>\
            <li><a href="./contact.php"> <i class="fas fa-mobile-alt"></i>Contact</a></li>\
            <li><a href="./suport.php"><i class="fas fa-question-circle"></i>Suport</a></li>\
            <li><a href="./about.php"><i class="fas fa-info-circle"></i>Despre</a></li>\
