document.write(
    ...
    <nav class="navbar">\
        ...
        <ul>\
            ...
            <li><a href="./events.html"><i class="fas fa-calendar-week"></i>Evenimente</a></li>\
            <li><a href="./trainings.html"><i class="fas fa-user-graduate"></i>Training-uri</a></li>\
            <li><a href="./contact.html"> <i class="fas fa-mobile-alt"></i>Contact</a></li>\
            <li><a href="./suport.html"><i class="fas fa-question-circle"></i>Suport</a></li>\
            <li><a href="./about.html"><i class="fas fa-info-circle"></i>Despre</a></li>\
